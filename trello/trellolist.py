...
class List(TrelloBase):
    ...
    def move_card(self, ListaDestino, Card):
        requests.put('https://api.trello.com/1/cards/' + Card.id, 
                    params=dict(key='cd17fd0b09001a5e435cd85369581f76', token='92c666944449616ff7a1ae49dc701768a36112316127499ffedac34749829575'), 
                    data=dict(idList=ListaDestino.id))
    
    def delete_card(self, Card):
        requests.delete('https://api.trello.com/1/cards/' + Card.id, 
                    params=dict(key='cd17fd0b09001a5e435cd85369581f76', token='92c666944449616ff7a1ae49dc701768a36112316127499ffedac34749829575'))
